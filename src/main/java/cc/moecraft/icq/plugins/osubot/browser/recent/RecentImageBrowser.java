 ...
 * @author Hykilpikonna
 */
public class RecentImageBrowser
{
    ...
    public File getUserSkillsImage(String username) throws UserNotFoundException
    {
        try
        {
            ...
            // 缓存到文件
            File file = new File("./cache/image/recent/recent-cr-" + System.currentTimeMillis() + ".png");
    ...
    public RecentImageBrowser setRunning(boolean running)
    {
