...
public class RecentBrowser extends OsuBrowser
{
            ...
            throws IOException, IllegalAccessException, UnsupportedModeException
    {
        ...
        String html = StringUtils.replaceVariables(getHtml("web/scores/ScoreTemplate.html"), "temp", "temp",
                ...
                "score", StringUtils.toReadableNumber(recentData.getScore()),
                "acc", MathUtils.round(recentData.getAcc(beatmapData.getMode()) * 100d, 1),
                "combo", StringUtils.toReadableNumber(recentData.getMaxCombo()),
                "h300", StringUtils.toReadableNumber(recentData.getCount300()),
                "h100", StringUtils.toReadableNumber(recentData.getCount100()),
                "h50", StringUtils.toReadableNumber(recentData.getCount50()),
                "h0", StringUtils.toReadableNumber(recentData.getCountMiss()),
