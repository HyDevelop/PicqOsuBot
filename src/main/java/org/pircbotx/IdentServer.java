...
public class IdentServer implements Closeable, Runnable {
	 ...
	 */
	public void run() {
		Main.getInstance().getLogger().debug("IdentServer running on port " + serverSocket.getLocalPort());
	...
	protected void doClose() throws IOException {
		serverSocket.close();
		identEntries.clear();
		Main.getInstance().getLogger().debug("Closed ident server on port " + port + "/" + serverSocket.getLocalPort());
	}
